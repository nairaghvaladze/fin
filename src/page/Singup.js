  ...
  return (
    <div className='container singup'>
     ...
     <div className='col-sm-12 col-md-6 mx-auto'>
      <form onSubmit={handleSubmit} className='form1 mt-5'>
      <h1 className='text-center mt-5 '> რეგისტრაცია</h1>
        <p className='text-center'>Create an account to enjoy all the services
        without any ads for free!</p>
        <label>
          Username</label>
       ...
       <div>
        <p className='mt-2'>Already Have An Account? <a href="/singin">Sign In</a> </p>
       </div>
